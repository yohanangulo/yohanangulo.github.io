...
// Define the project type based on the JSON data
type Project = {
  id: number
  title: string
  description: string
...
export default function AllProjects() {
  ...
  return (
    <div className="bg-background-light dark:bg-background-dark font-display antialiased min-h-screen flex flex-col overflow-x-hidden">
      {/* Header */}
      <div className="w-full border-b border-solid border-surface-border bg-background-dark">
        <div className="px-4 md:px-10 py-3 flex justify-center">
          <div className="w-full max-w-[1200px] flex items-center justify-between whitespace-nowrap">
            <div className="flex items-center gap-4 text-white">
              ...
              <h2 className="text-white text-xl font-bold leading-tight tracking-[-0.015em]">Portfolio</h2>
            </div>
            <div className="hidden md:flex flex-1 justify-end gap-8">
              <div className="flex items-center gap-9">
                <a className="text-white hover:text-primary transition-colors text-sm font-medium leading-normal" href="/">
                  Home
                </a>
                <a className="text-primary text-sm font-medium leading-normal" href="/projects">
                  Projects
                </a>
                <a className="text-white hover:text-primary transition-colors text-sm font-medium leading-normal" href="#">
                  About
                ...
                <button
                  ...
                  className={`flex h-9 shrink-0 items-center justify-center gap-x-2 rounded-lg pl-3 pr-5 transition-all ${
                    filter === item
                      ...
                      : 'bg-surface-border hover:bg-surface-dark'
                  }`}
                >
          ...
          {visibleCount < filteredProjects.length && (
            <div className="flex justify-center pt-8 pb-10">
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-surface-border hover:bg-surface-dark text-white rounded-lg transition-colors font-medium text-sm"
              >

...
const features = [
  { icon: 'speed', name: 'Performance' },
  { icon: 'devices', name: 'Responsive' },
  { icon: 'account_balance', name: 'Clean Arch' },
]
    ...
    <section className="w-full bg-surface-dark/30 border-y border-border-dark/30 py-16 md:py-24" id="about">
      <motion.div {...legacyAnimations.fadeInAnimation} className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg text-slate-400 leading-relaxed mb-10">
          I don&apos;t just write Dart; I build products. With over 6 years of experience in mobile development, I bridge the gap
          between complex engineering challenges and seamless user experiences. I specialize in optimizing app performance,
          reducing build sizes, and setting up scalable CI/CD workflows for engineering teams.
        </p>
